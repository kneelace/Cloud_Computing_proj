...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="menhalfsleeve.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee14.php">Captain America Halftone (AVL)</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
